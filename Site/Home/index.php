        ...
        <div class="row">
            ...
            <div class="jumbotron col-sm-8 p-4 main-content">
                ...
                <div> На данный момент приложение настроено для работы с доменом localhost.
                     Инструкция по настройке находится в файле ProjectSettings/recaptcha.txt
                </div>
                <h4>Инструкция по настройке отправки сообщения на почтовый ящик администратора</h4> 
                <div> На данный момент приложение отключено для отправки e-mail сообщений. 
                     Инструкция по настройке почтового сервиса находится в файле ProjectSettings/mail.txt
                </div>
